...
$spreadsheet->getProperties()->setCreator('E-logic.Inc')
    ...
    ->setTitle('FulfillmentPendingReport')
    ->setSubject('FulfillmentPendingReport')
    ->setDescription('FulfillmentPendingReport')
    ->setKeywords('FulfillmentPendingReport')
    ->setCategory('FulfillmentPendingReport');
...
ExcelRepository::fulfillment_pending_report(Conexion::obtener_conexion(), $spreadsheet);
Conexion::cerrar_conexion();

$spreadsheet->setActiveSheetIndex(0);

header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="FulfillmentPendingReport.xlsx"');
