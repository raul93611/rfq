...
$activeWorksheet->getStyle('J1:M1')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('f0e716');
$activeWorksheet->setCellValue('J1', 'RE-QUOTE');
$activeWorksheet->getStyle('N1:Q1')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('dc3545');
$activeWorksheet->setCellValue('N1', 'FULFILLMENT');
...
$activeWorksheet->getStyle('N2')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('dc3545');
$activeWorksheet->setCellValue('N2', 'TOTAL COST');
$activeWorksheet->getStyle('O2')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('dc3545');
$activeWorksheet->setCellValue('O2', 'TOTAL PRICE');
$activeWorksheet->getStyle('P2')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('dc3545');
$activeWorksheet->setCellValue('P2', 'PROFIT RFQ');
$activeWorksheet->getStyle('Q2')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('dc3545');
$activeWorksheet->setCellValue('Q2', 'PROFIT RFP');
$activeWorksheet->setCellValue('R2', 'TYPE OF CONTRACT');
$activeWorksheet->setCellValue('S2', 'SALES COMMISSION');
$activeWorksheet->setCellValue('T2', 'SALES COMMISSION AMOUNT');
