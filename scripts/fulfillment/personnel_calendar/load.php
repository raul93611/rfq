  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <input type="text" id="name" name="name" class="form-control form-control-sm" value="<?= htmlspecialchars($event->getName(), ENT_QUOTES, 'UTF-8'); ?>">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          <input type="text" id="color" class="form-control form-control-sm" name="color" value="<?= htmlspecialchars($event->getColor(), ENT_QUOTES, 'UTF-8'); ?>">
          <div class="input-group-append">
            <span class="input-group-text" style="color: <?= htmlspecialchars($event->getColor(), ENT_QUOTES, 'UTF-8'); ?>;"><i class="fas fa-square"></i></span>
          </div>
        </div>
      </div>
    </div>
...
<div class="modal-footer">
  ...
  <button type="button" data-id="<?= htmlspecialchars($event->getId(), ENT_QUOTES, 'UTF-8'); ?>" class="delete-event-button btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
