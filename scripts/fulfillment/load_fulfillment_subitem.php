...
<div class="modal-body user-form">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="input-group input-group">
          ...
          <input type="number" step=".01" id="unit_cost" class="form-control" name="unit_cost"
  ...
  <div class="form-row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="input-group input-group">
          <div class="input-group-prepend"><span class="input-group-text">$</span></div>
          <input type="number" step=".01" id="other_cost" class="form-control" name="other_cost"
  ...
  <?php if ($_POST["isPartialInvoices"]) : ?>
    <div class="form-group">
      <label>Invoice</label>
      <select class="form-control form-control-sm" name="invoice">
  ...
  <div class="form-group">
    <label>Comment</label>
    <textarea id="comment" name="comment" class="form-control form-control-sm" rows="4"><?= htmlspecialchars($fulfillment_subitem?->get_comments() ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
  </div>
...
<div class="modal-footer d-flex justify-content-end" style="gap:8px;">
  ...
  <button type="submit" name="save_edit_fulfillment_subitem_button" class="btn btn-primary btn-sm"><i class="fa fa-check mr-1"></i> Save</button>
</div>
