  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <input type="text" id="transaction_date" readonly class="form-control form-control-sm" name="transaction_date" value="<?= date("m/d/Y", strtotime($fulfillment_subitem?->getTransactionDate() ?? date("m/d/Y"))) ?>">
      </div>
      <div class="form-group">
