  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <input type="hidden" name="provider_original" value="<?php echo $fulfillment_subitem-> get_provider(); ?>">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="quantity_original" value="<?php echo $fulfillment_subitem-> get_quantity(); ?>">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="unit_cost_original" value="<?php echo $fulfillment_subitem-> get_unit_cost(); ?>">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="other_cost_original" value="<?php echo $fulfillment_subitem-> get_other_cost(); ?>">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="payment_term_original" value="<?php echo $fulfillment_subitem-> get_payment_term(); ?>">
