...
FulfillmentItemRepository::update(Conexion::obtener_conexion(), $_POST['id_fulfillment_item'], $_POST['provider'], $_POST['quantity'], $_POST['unit_cost'], $_POST['other_cost'], $real_cost);
...
RepositorioRfq::set_fulfillment_profit(Conexion::obtener_conexion(), $item-> obtener_id_rfq());
