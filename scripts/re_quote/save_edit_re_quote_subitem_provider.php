...
if(isset($_POST['save_edit_re_quote_subitem_provider'])){
  ...
  ReQuoteSubitemProviderRepository::update_re_quote_subitem_provider(Database::get_connection(), $_POST['provider'], $_POST['price'], $_POST['id_re_quote_subitem_provider']);
  $re_quote_subitem_provider = ReQuoteSubitemProviderRepository::get_re_quote_subitem_provider_by_id(Database::get_connection(), $_POST['id_re_quote_subitem_provider']);
