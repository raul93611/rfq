...
$tasks_todo = TaskRepository::get_my_todo(Conexion::obtener_conexion());
$tasks_in_progress = TaskRepository::get_my_in_progress(Conexion::obtener_conexion());
$tasks_done = TaskRepository::get_my_done(Conexion::obtener_conexion());
