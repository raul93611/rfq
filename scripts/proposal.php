...
<table width="100%">
  <tr>
    ...
    <td><h2 class="color" style="margin-left:20px;">Proposal</h2></td>
    <td width="170" valign="top">
      <img style="width:170px;height:90px;padding-top:-25px;" src="' . RUTA_IMG . '/elogic_logo.png">
    </td>
  </tr>
</table>
...
The agency CO should send "Offer Letter" and PWS to dcofferletters@sba.gov. The SBA processes the Offer Letter and returns it to the agency CO within 5 business days for contract processing.
  ...
  <tr>
    ...
    <td style="font-size:16px;border:none;"><b>TOTAL:</b></td>
    <td style="border:none;"></td>
    <td style="border:none;"></td>
    <td style="font-size:16px;text-align:right;"><b>$ ' . $cotizacion->obtener_total_price() . '</b></td>
  </tr>';
    $html .= '</table>';
}
