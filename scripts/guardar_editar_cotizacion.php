...
if (isset($_POST['guardar_cambios_cotizacion'])) {
  ...
  $cotizacion_editada4 = RepositorioRfq::actualizar_rfq_inicio(Conexion::obtener_conexion(), $_POST['email_code'], $_POST['type_of_bid'], $_POST['issue_date'], $_POST['end_date'], $_POST['canal'], $_POST['contract_number'], $_POST['id_rfq']);
