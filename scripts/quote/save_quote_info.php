...
if(isset($_POST['save_quote_info'])){
  ...
  $cotizacion_editada4 = RepositorioRfq::actualizar_rfq_inicio(Conexion::obtener_conexion(), $expiration_date, $fecha_completado, htmlspecialchars($_POST['ship_to']), htmlspecialchars($_POST['address']), $_POST['ship_via'], $_POST['comments'], $usuario_designado, $_POST['email_code'], $_POST['type_of_bid'], $_POST['issue_date'], $_POST['end_date'], $_POST['canal'], $_POST['contract_number'], $_POST['city'], $_POST['zip_code'], $_POST['state'], $_POST['client'], $_POST['id_rfq']);
  $cotizacion_recuperada = RepositorioRfq::obtener_cotizacion_por_id(Conexion::obtener_conexion(), $_POST['id_rfq']);
