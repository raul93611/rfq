...
try {
  ...
  // Fetch data
  $quotes = RepositorioRfq::getCompletedQuotesByChannel($conexion, $start, $length, $search, $sort_column_index, $sort_direction, $channel);
  $total_records = RepositorioRfq::getTotalCompletedQuotesByChannelCount($conexion, $channel);
  $total_filtered_records = RepositorioRfq::getTotalFilteredCompletedQuotesByChannelCount($conexion, $channel, $search);
