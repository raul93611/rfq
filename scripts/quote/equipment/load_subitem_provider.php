...
$provider = RepositorioProviderSubitem::obtener_provider_subitem_por_id(Conexion::obtener_conexion(), $_POST['id']);
Conexion::cerrar_conexion();
?>
<input type="hidden" name="id_subitem_provider" value="<?= $_POST['id']; ?>">
<div class="row">
  <div class="col-md-12">
