...
try {
  ...
  // Fetch data
  $quotes = RepositorioRfq::getCreatedQuotesByChannel($conexion, $start, $length, $search, $sort_column_index, $sort_direction, $channel);
  $total_records = RepositorioRfq::getTotalCreatedQuotesByChannelCount($conexion, $channel);
  $total_filtered_records = RepositorioRfq::getTotalFilteredCreatedQuotesByChannelCount($conexion, $channel, $search);
