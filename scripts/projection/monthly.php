...
try {
  ...
  // Fetch data
  $items = YearlyProjectionRepository::getMonthly($conexion, $start, $length, $search, $sort_column_index, $sort_direction, $id);
  $total_records = YearlyProjectionRepository::getTotalMonthlyCount($conexion, $id);
  $total_filtered_records = YearlyProjectionRepository::getTotalFilteredMonthlyCount($conexion, $search, $id);
