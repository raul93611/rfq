...
<div class="modal-body">
  ...
  <div class="form-group">
    ...
    <input type="text" id="carrier" name="carrier" class="form-control form-control-sm" value="<?php echo $tracking_subitem-> get_carrier(); ?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control form-control-sm" name="comments" rows="5" id="comments"><?php echo $tracking_subitem-> get_comments(); ?></textarea>
  </div>
</div>
