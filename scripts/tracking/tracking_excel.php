...
$activeWorksheet->setCellValue($x . '1', 'PROPOSAL #');$x++;
$activeWorksheet->getStyle($x . '1')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . '1', 'CONTRACT NUMBER');

$x = 'A';
$activeWorksheet->setCellValue($x . '2', $quote-> obtener_id());$x++;
...
$activeWorksheet->setCellValue($x . $y, '#');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'PROJECT ESPC');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'QTY(ORDERED)');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'QTY(SHIPPED)');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'CARRIER');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'TRACKING #');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'DELIVERY DATE');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'DUE DATE');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'SIGNED BY');$x++;
$activeWorksheet->getStyle($x . $y)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setARGB('ed9191');
$activeWorksheet->setCellValue($x . $y, 'COMMENT');$x++;
