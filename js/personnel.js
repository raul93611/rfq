    ...
    columns: [
      ...
      { data: "type" },
      {
        ...
        render: (data, type, row) => {
          if (type === 'display') {
            return `
              <button data-id="${row.id}" class="edit-personnel-button btn btn-sm btn-secondary">
                <i class="fas fa-pen"></i>
              </button>
              <button data-id="${row.id}" class="delete-personnel-button btn btn-sm btn-secondary">
