...
?>
  ...
  public static function item_list($item, $i, $id_rfq) {
    ...
    <tr>
      ...
      if (count($fulfillment_items)) {
      ?>
        <td class="item<?php echo $fulfillment_items[0]->get_id() . ($fulfillment_items[0]->get_reviewed() ? ' success-opacity' : ''); ?> align-middle text-center">
        ...
        <td class="item<?php echo $fulfillment_items[0]->get_id() . ($fulfillment_items[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_items[0]->get_provider(); ?></td>
        <td class="item<?php echo $fulfillment_items[0]->get_id() . ($fulfillment_items[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_items[0]->get_quantity(); ?></td>
        <td class="item<?php echo $fulfillment_items[0]->get_id() . ($fulfillment_items[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_items[0]->get_unit_cost(); ?></td>
        <td class="item<?php echo $fulfillment_items[0]->get_id() . ($fulfillment_items[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_items[0]->get_other_cost(); ?></td>
        <td class="item<?php echo $fulfillment_items[0]->get_id() . ($fulfillment_items[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_items[0]->get_real_cost(); ?></td>
        <td class="item<?php echo $fulfillment_items[0]->get_id() . ($fulfillment_items[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_items[0]->get_payment_term(); ?></td>
  ...
  <tr>
    ...
    <?php
      if (count($fulfillment_subitems)) {
    ?>
      <td class="subitem<?php echo $fulfillment_subitems[0]->get_id() . ($fulfillment_subitems[0]->get_reviewed() ? ' success-opacity' : ''); ?> align-middle text-center">
      ...
      <td class="subitem<?php echo $fulfillment_subitems[0]->get_id() . ($fulfillment_subitems[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_subitems[0]->get_provider(); ?></td>
      <td class="subitem<?php echo $fulfillment_subitems[0]->get_id() . ($fulfillment_subitems[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_subitems[0]->get_quantity(); ?></td>
      <td class="subitem<?php echo $fulfillment_subitems[0]->get_id() . ($fulfillment_subitems[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_subitems[0]->get_unit_cost(); ?></td>
      <td class="subitem<?php echo $fulfillment_subitems[0]->get_id() . ($fulfillment_subitems[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_subitems[0]->get_other_cost(); ?></td>
      <td class="subitem<?php echo $fulfillment_subitems[0]->get_id() . ($fulfillment_subitems[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_subitems[0]->get_real_cost(); ?></td>
      <td class="subitem<?php echo $fulfillment_subitems[0]->get_id() . ($fulfillment_subitems[0]->get_reviewed() ? ' success-opacity' : ''); ?>"><?php echo $fulfillment_subitems[0]->get_payment_term(); ?></td>
