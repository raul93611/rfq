...
class ReQuoteItem{
  ...
  public function __construct($id, $id_re_quote, $brand, $brand_project, $part_number, $part_number_project, $description, $description_project, $quantity, $unit_price, $total_price, $comments, $website, $additional){
    $this-> id = $id;
