...
class ValidadorRegistro extends ValidadorUsuario{
  public function __construct($nombre_usuario, $password1, $password2, $nombres, $apellidos, $database) {
    ...
    $this-> error_nombre_usuario = $this-> validar_nombre_usuario($nombre_usuario, $database);
    $this-> error_nombres = $this->validar_nombres($nombres);
    $this-> error_apellidos = $this->validar_apellidos($database, $apellidos, $nombres);
