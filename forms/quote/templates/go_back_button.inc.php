...
if ($cotizacion_recuperada->getDeleted()) {
  echo '<a class="btn btn-primary" id="go_back" href="' . DELETED . '"><i class="fa fa-reply"></i></a>';
  ...
  echo '<a class="btn btn-primary" id="go_back" href="' . COMPLETED . $canal . '"><i class="fa fa-reply"></i></a>';
  ...
  echo '<a class="btn btn-primary" id="go_back" href="' . CHANNEL . $canal . '"><i class="fa fa-reply"></i></a>';
}
