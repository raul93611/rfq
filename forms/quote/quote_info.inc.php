  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <select class="form-control form-control-sm" name="type_of_bid" id="type_of_bid">
        ...
        ?>
          <option <?php if ($cotizacion_recuperada->obtener_type_of_bid() == $type_of_bid->get_type_of_bid()) {
                    echo 'selected';
                  } ?>><?php echo $type_of_bid->get_type_of_bid(); ?></option>
        <?php
        }
        ?>
      </select>
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <select class="form-control form-control-sm" name="canal" id="canal">
        <option <?php if ($cotizacion_recuperada->obtener_canal() == 'GSA-Buy') {
                  echo 'selected';
                } ?>>GSA-Buy</option>
        <option value="Fedbid" <?php if ($cotizacion_recuperada->obtener_canal() == 'FedBid') {
                                  echo 'selected';
                                } ?>>Unison</option>
        <option <?php if ($cotizacion_recuperada->obtener_canal() == 'E-mails') {
                  echo 'selected';
                } ?>>E-mails</option>
        <option <?php if ($cotizacion_recuperada->obtener_canal() == 'Embassies') {
                  echo 'selected';
                } ?>>Embassies</option>
        <option value="FBO" <?php if ($cotizacion_recuperada->obtener_canal() == 'FBO') {
                              echo 'selected';
                            } ?>>SAM</option>
        <option <?php if ($cotizacion_recuperada->obtener_canal() == 'Seaport') {
                  echo 'selected';
                } ?>>Seaport</option>
        <option <?php if ($cotizacion_recuperada->obtener_canal() == 'Ebay & Amazon') {
                  echo 'selected';
                } ?>>Ebay & Amazon</option>
        <option <?php if ($cotizacion_recuperada->obtener_canal() == 'Stars III') {
                  echo 'selected';
                } ?>>Stars III</option>
      </select>
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <select id="state" class="form-control form-control-sm" name="state">
        ...
        ?>
          <option value="<?php echo $key; ?>" <?php echo $cotizacion_recuperada->obtener_state() == $key ? 'selected' : ''; ?>><?php echo $state; ?></option>
        <?php
        }
        ?>
      </select>
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <select id="comments" class="form-control form-control-sm" name="comments">
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'No comments') {
                  echo 'selected';
                } ?>>No comments</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'QuickBooks') {
                  echo 'selected';
                } ?>>QuickBooks</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'No Bid') {
                  echo 'selected';
                } ?>>No Bid</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'Manufacturer in the Bid') {
                  echo 'selected';
                } ?>>Manufacturer in the Bid</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'Expired due date') {
                  echo 'selected';
                } ?>>Expired due date</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'Supplier did not provide a quote') {
                  echo 'selected';
                } ?>>Supplier did not provide a quote</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'Others') {
                  echo 'selected';
                } ?>>Others</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'Not submitted') {
                  echo 'selected';
                } ?>>Not submitted</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'Cancelled') {
                  echo 'selected';
                } ?>>Cancelled</option>
        <option <?php if ($cotizacion_recuperada->obtener_comments() == 'Working on it') {
                  echo 'selected';
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <select id="ship_via" class="form-control form-control-sm" name="ship_via">
        <option <?php if ($cotizacion_recuperada->obtener_ship_via() == 'GROUND') {
                  echo 'selected';
                } ?>>GROUND</option>
        <option <?php if ($cotizacion_recuperada->obtener_ship_via() == 'BEST WAY') {
                  echo 'selected';
                } ?>>BEST WAY</option>
      </select>
