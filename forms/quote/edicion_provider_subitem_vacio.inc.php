...
<div class="card-body user-form">
  <div class="form-row">
    <div class="form-group col-md-7">
      ...
      <input type="text" class="form-control form-control-sm" id="provider" name="provider" placeholder="Provider name ..." autofocus required value="<?= htmlspecialchars($provider_subitem->obtener_provider()); ?>">
    </div>
    <div class="form-group col-md-5">
      <label for="price">Price (USD)</label>
      <div class="input-group input-group">
        <div class="input-group-prepend"><span class="input-group-text">$</span></div>
        <input type="number" step=".01" min="0" class="form-control" id="price" name="price" placeholder="0.00" required value="<?= htmlspecialchars($provider_subitem->obtener_price()); ?>">
      </div>
    </div>
  </div>
</div>
...
<div class="card-footer d-flex justify-content-between align-items-center">
  <a href="<?= DELETE_PROVIDER_SUBITEM . '/' . htmlspecialchars($id_provider_subitem); ?>" class="delete_provider_subitem_button btn btn-danger btn-sm">
  ...
  <div style="display:flex;gap:8px;">
    ...
    <button type="submit" class="btn btn-primary btn-sm" name="guardar_cambios_provider_subitem">
