  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <small class="form-text text-muted">Add a description for the e-logic proposal.</small>
      </div>
    </div>
  </div>
  <div class="form-group">
    ...
    <small class="form-text text-muted">Specify the quantity of items needed.</small>
  </div>
  <div class="form-group">
    <label for="comments">Comments:</label>
    <textarea class="summernote_textarea form-control form-control-sm" rows="5" name="comments"></textarea>
    <small class="form-text text-muted">Add any additional comments or notes.</small>
  </div>
  <div class="form-group">
    <label for="website">Website:</label>
    <input type="text" class="form-control form-control-sm" name="website">
    <small class="form-text text-muted">Provide the relevant website URL.</small>
  </div>
</div>
<div class="card-footer">
  <button type="submit" class="btn btn-primary" name="save_re_quote_item"><i class="fa fa-check"></i> Save</button>
  <a href="<?= RE_QUOTE . $re_quote->get_id_rfq(); ?>" class="btn btn-secondary"><i class="fa fa-times"></i> Cancel</a>
</div>