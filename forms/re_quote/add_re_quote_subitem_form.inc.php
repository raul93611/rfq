...
<div class="card-body user-form">
  ...
  <div class="item-extra-fields">
    ...
    <div class="form-group mb-0">
      ...
      <textarea class="form-control form-control-sm" rows="4" name="comments" placeholder="Additional comments ..."></textarea>
    </div>
  </div>
</div>
<div class="card-footer d-flex justify-content-between align-items-center" style="gap:8px;">
  ...
  <button type="submit" class="btn btn-primary btn-sm" name="save_re_quote_subitem">
