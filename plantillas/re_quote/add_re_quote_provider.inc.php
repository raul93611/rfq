...
$_rq_item = ReQuoteItemRepository::get_re_quote_item_by_id(Conexion::obtener_conexion(), $id_re_quote_item);
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
          <div class="chart-card">
            <form role="form" method="post" action="<?= SAVE_RE_QUOTE_PROVIDER; ?>">
              <?php include_once 'forms/re_quote/add_re_quote_provider_form.inc.php'; ?>
            </form>
          </div>
        </div>
      </div>
