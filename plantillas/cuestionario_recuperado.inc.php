...
<div class="card-body">
    ...
    <div class="form-group">
        <div class="form-check-inline">
            <input class="form-check-input" type="radio" value="multiple" name="locations" <?php if($cuestionario-> obtener_locations() == 'multiple'){echo 'checked';} ?>>
            <label class="form-check-label">Multiple</label>
        </div>
        <div class="form-check-inline">
            <input class="form-check-input" type="radio" value="one_location" name="locations" <?php if($cuestionario-> obtener_locations() == 'one_location'){echo 'checked';} ?>>
