...
<div class="card-body">
    ...
    <a class="btn btn-warning btn-sm float-right" href="<?php echo ADD_HIGH_LEVEL_REQUIREMENT . '/' . $cuestionario-> obtener_id(); ?>">Add</a>
    <?php
    ...
    <a class="btn btn-warning btn-sm float-right" href="<?php echo ADD_OUT_OF_SCOPE . '/' . $cuestionario-> obtener_id(); ?>">Add</a>
    <?php
    RepositorioOutOfScope::escribir_out_of_scopes($cuestionario-> obtener_id());
    ?>
    <hr>
    <h3 class="card-title">PROJECT RISKS</h3>
    <a class="btn btn-warning btn-sm float-right" href="<?php echo ADD_PROJECT_RISK . '/' . $cuestionario-> obtener_id(); ?>">Add</a>
    <?php
    RepositorioProjectRisk::escribir_project_risks($cuestionario-> obtener_id());
    ?>
    <hr>
    <h3 class="card-title">PROJECT MILESTONES</h3>
    <a class="btn btn-warning btn-sm float-right" href="<?php echo ADD_PROJECT_MILESTONE . '/' . $cuestionario-> obtener_id(); ?>">Add</a>
    <?php  
