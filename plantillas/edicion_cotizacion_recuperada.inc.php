...
<div class="card-body">
    ...
    <!--<div class="form-group">
        ...
        <select id="payment_terms" class="form-control" name="payment_terms">
            <option <?php
            /*if ($cotizacion_recuperada->obtener_payment_terms() == 'Net 30') {
                echo 'selected';
            }
            ?>>Net 30</option>
            <option <?php
            if ($cotizacion_recuperada->obtener_payment_terms() == 'Net 30/CC') {
                echo 'selected';
            }*/
            ?>>Net 30/CC</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select id="ship_via" class="form-control" name="ship_via">
            <option <?php/*
            if ($cotizacion_recuperada->obtener_ship_via() == 'GROUND') {
                echo 'selected';
            }*/
            ?>>GROUND</option>
            <option <?php
            /*if ($cotizacion_recuperada->obtener_ship_via() == 'BEST WAY') {
                echo 'selected';
            }*/
            ?>>BEST WAY</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select id="comments" class="form-control" name="comments">
            <option <?php
            #if ($cotizacion_recuperada->obtener_comments() == 'No comments') {
            #    echo 'selected';
            #}
            ?>>No comments</option>
            <option <?php
            #if ($cotizacion_recuperada->obtener_comments() == 'No Bid') {
            #    echo 'selected';
            #}
            ?>>No Bid</option>
            <option <?php
            #if ($cotizacion_recuperada->obtener_comments() == 'Manufactured in the Bid') {
            #    echo 'selected';
            #}
            ?>>Manufacturer in the Bid</option>
            <option <?php
            #if ($cotizacion_recuperada->obtener_comments() == 'Expired due date') {
            #    echo 'selected';
            #}
            ?>>Expired due date</option>
            <option <?php
            #if ($cotizacion_recuperada->obtener_comments() == 'Supplier did not provide a quote') {
            #    echo 'selected';
            #}
