    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="brand_project" name="brand_project" placeholder="Brand ..." autofocus required>
            </div>
            <div class="form-group">
                <label for="part_number_project">Part #:</label>
                <input type="text" class="form-control" id="part_number_project" name="part_number_project" placeholder="Part # ..." required>
            </div>
            <div class="form-group">
                <label for="description_project">Description:</label>
                <textarea class="form-control" rows="5" placeholder="Enter description ..." id="description_project" name="description_project" required></textarea>
            </div>
        </div>
        <div class="col">
