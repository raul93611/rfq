...
<div class="content-wrapper">
  ...
  <div class="content-header page-header-bar">
    <div>
      <h1 class="page-title">Submitted Quotes</h1>
  ...
  <section class="content" style="padding-top:20px;">
    <div class="container-fluid">
      <div class="card chart-card">
        <div class="card-body">
          <table id="submitted_table" data-channel="<?= htmlspecialchars($channel, ENT_QUOTES, 'UTF-8'); ?>" class="table table-bordered table-hover">
            <thead>
              <tr>
                <th>Proposal</th>
