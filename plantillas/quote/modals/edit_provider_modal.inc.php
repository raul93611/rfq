<div class="modal fade" id="edit-provider-modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered iem-dialog iem-dialog-sm" role="document">
    <div class="modal-content iem-content">
      ...
      <div class="modal-header iem-header">
        <div class="iem-header-left">
          ...
          <div>
            ...
            <div class="iem-subtitle" id="edit-provider-subtitle">Loading…</div>
          </div>
        </div>
      ...
      <form id="iem-edit-provider-form" novalidate>
        <div class="modal-body iem-body" id="iem-edit-provider-body">
        ...
        <div class="modal-footer iem-footer">
          <div class="iem-footer-row" style="width:100%;">
            <div id="iem-edit-provider-warn" class="iem-footer-warn" style="display:none;width:100%;margin-bottom:8px;">
          ...
          <div class="iem-footer-row" style="width:100%;justify-content:space-between;">
            <button type="button" class="iem-btn iem-btn-danger iem-delete-provider-btn">
