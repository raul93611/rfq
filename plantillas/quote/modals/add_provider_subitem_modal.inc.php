<div class="modal fade" id="add-provider-subitem-modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered iem-dialog iem-dialog-sm" role="document">
    <div class="modal-content iem-content">
      ...
      <div class="modal-header iem-header">
        <div class="iem-header-left">
          ...
          <div>
            ...
            <div class="iem-subtitle" id="add-provider-subitem-subtitle">Proposal #<?= htmlspecialchars($id_rfq, ENT_QUOTES, 'UTF-8'); ?></div>
          </div>
        </div>
      ...
      <form id="iem-add-provider-subitem-form" novalidate>
        <input type="hidden" id="iem-add-psi-id-subitem" name="id_subitem" value="">
        <div class="modal-body iem-body">
          <div class="card-body user-form">
            <div class="form-row">
              <div class="form-group col-md-7">
                <label for="iem-psi-name">Provider</label>
                <input type="text" class="form-control form-control-sm" id="iem-psi-name" name="provider" placeholder="Provider name ..." autofocus required>
              </div>
              <div class="form-group col-md-5">
                <label for="iem-psi-price">Price (USD)</label>
                <div class="input-group input-group-sm">
                  <div class="input-group-prepend"><span class="input-group-text">$</span></div>
                  <input type="number" step=".01" min="0" class="form-control" id="iem-psi-price" name="price" placeholder="0.00" required>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer iem-footer">
          <div class="iem-footer-row" style="width:100%;">
            <div id="iem-add-psi-warn" class="iem-footer-warn" style="display:none;width:100%;margin-bottom:8px;">
