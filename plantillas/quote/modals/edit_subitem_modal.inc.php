<div class="modal fade" id="edit-subitem-modal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content iem-content">
      ...
      <div class="modal-header iem-header">
        <div class="iem-header-left">
          ...
          <div>
            <div class="iem-title">Edit Subitem</div>
            <div class="iem-subtitle" id="edit-subitem-subtitle">Loading…</div>
          </div>
        </div>
      ...
      <form id="iem-edit-subitem-form" novalidate>
        <div class="modal-body iem-body" id="iem-edit-subitem-body">
        ...
        <div class="modal-footer iem-footer">
          <div class="iem-footer-row" style="width:100%;">
            <div id="iem-edit-subitem-warn" class="iem-footer-warn" style="display:none;width:100%;margin-bottom:8px;">
