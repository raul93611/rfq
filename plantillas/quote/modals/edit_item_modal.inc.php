    ...
    <div class="modal-content iem-content">
      ...
      <div class="modal-header iem-header">
        <div class="iem-header-left">
          ...
          <div>
            <div class="iem-title">Edit Item</div>
            <div class="iem-subtitle" id="edit-item-subtitle">Loading…</div>
          </div>
        </div>
      ...
      <form id="iem-edit-item-form" novalidate>
        <div class="modal-body iem-body" id="iem-edit-item-body">
        ...
        <div class="modal-footer iem-footer">
          <div class="iem-footer-row" style="width:100%;">
            <div id="iem-edit-item-warn" class="iem-footer-warn" style="display:none;width:100%;margin-bottom:8px;">
