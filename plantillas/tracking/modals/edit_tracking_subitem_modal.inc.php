  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content" style="border-radius:12px;overflow:hidden;">
      <div class="modal-header" style="background:var(--color-dark);color:#fff;border:none;">
        <h5 class="modal-title" id="editTrackingSubitemLabel" style="font-size:14px;font-weight:700;">
          <i class="fas fa-truck mr-2"></i> Edit Tracking Subitem
        </h5>
      ...
      <div class="modal-footer" style="border-top:1px solid #f0f0f0;">
        ...
        <button type="submit" form="edit_tracking_subitem_form" class="btn btn-primary btn-sm">
