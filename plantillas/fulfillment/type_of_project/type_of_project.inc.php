  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <button id="add-type-of-project-button" class="float-right btn btn-primary" type="button" name="button"><i class="fas fa-plus"></i></button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <section class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <table id="type-of-project-table" class="table table-bordered">
                <thead>
                  <tr>
                    <th>ID</th>
                    <th>NAME</th>
