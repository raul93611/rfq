<div class="modal fade" id="new_fulfillment_subitem_modal" tabindex="-1" role="dialog" aria-labelledby="newFulfillmentSubitemModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content" style="border-radius:12px;overflow:hidden;">
      <div class="modal-header" style="background:var(--color-dark);color:#fff;border:none;">
        <h5 class="modal-title"><i class="fas fa-plus-circle mr-2"></i> Add Fulfillment Subitem</h5>
