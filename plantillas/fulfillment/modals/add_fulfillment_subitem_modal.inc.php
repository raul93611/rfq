          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="net30_cc_subitem" name="net30_cc" value="1">
                <label class="custom-control-label" for="net30_cc_subitem">Net 30/CC</label><br>
