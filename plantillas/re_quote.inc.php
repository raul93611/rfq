...
if(!$re_quote_exists){
  if($cotizacion-> obtener_canal() == 'FedBid'){
    $re_quote = new ReQuote('', $id_rfq, $cotizacion-> obtener_total_cost(), $cotizacion-> obtener_total_price(), '', 0, 0, 0, 0, '');
              ...
              <div class="card-body">
                ...
                if($cotizacion-> obtener_canal() == 'FedBid'){
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" step=".01" class="form-control form-control-sm" name="total_cost" value="<?php echo $re_quote-> get_total_cost(); ?>">
                  </div>
                  <div class="form-group">
                    <label for="total_price">Total price:</label>
                    <input type="number" step=".01" class="form-control form-control-sm" name="total_price" value="<?php echo $re_quote-> get_total_price(); ?>">
                  </div>
                  <?php
                }else{
